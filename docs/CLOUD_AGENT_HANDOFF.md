...
3a. Send Offer may freeze an optional **shipping fee override** on the offer. Blank leaves Shopify's quoted rate on the later draft order. A number, including 0, becomes a custom `shippingLine`. This is carrier shipping, not the FedEx upgrade product.
