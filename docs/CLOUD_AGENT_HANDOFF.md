...
3a. Send Offer may freeze an optional **ADD ON** amount on the offer. Blank leaves Shopify's quoted rate on the later draft order. A number, including 0, becomes a custom `shippingLine` titled **ADD ON**. This is not the FedEx upgrade product.
