...
CREATE TABLE "RequestInternalNote" (
    ...
    CONSTRAINT "RequestInternalNote_pkey" PRIMARY KEY ("id")
);

CREATE INDEX "RequestInternalNote_shop_requestId_createdAt_idx" ON "RequestInternalNote"("shop", "requestId", "createdAt");

ALTER TABLE "RequestInternalNote" ADD CONSTRAINT "RequestInternalNote_requestId_fkey" FOREIGN KEY ("requestId") REFERENCES "PlantRequest"("id") ON DELETE CASCADE ON UPDATE CASCADE;
