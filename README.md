...
Required Shopify scopes (merchants must re-approve after install): `write_draft_orders`, `read_draft_orders`, `read_orders`, `read_customers`, `write_files`, `read_files`, `read_products`, `write_products`, `read_publications`, `write_publications`, `write_app_proxy`.
