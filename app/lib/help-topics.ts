...
export const HELP_TOPICS: HelpTopic[] = [
  ...
  },
  {
    ...
    detail: [
      ...
      "On approve, one Shopify product is created per item with vendor **Unsolicited Plant Talks**, added to the existing EXACT PLANTS collection, given a variant that tracks inventory and denies oversell, stocked with one unit at the shop's primary location, and only then published — to Online Store and Point of Sale only. Publishing before stocking would show the plant as sold out.",
